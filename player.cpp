...
//#include "bro/fonts/fontawesome.h"
//#include "bro/fonts/source_code_pro.h"
//#include "bro/fonts/unifont.h"
//#include <strnatcmp.h>
//#include "theme.h"
#include "player.h"
#include <iostream>
...
namespace ImPlay {
    ...
    bool Player::init() {
...

        {
            ...
            //logoTexture = ImGui::LoadTexture("icon.png");//DISABLECRAVEN ROMFS
    ...
    void Player::draw() {
        ...
        ImGui::OpenPopup("views.about.title");
        bool m_open = true;
...
//#endif
    ...
    void Player::initGui() {
        ...
        //if (config->Data.Interface.Docking) 
...
//            //style.WindowShadowSize = 50.0f;//DISABLECRAVEN
//            style.ScrollbarSize = 10.0f;
//            //style.Colors[ImGuiCol_WindowShadow] = ImVec4(0, 0, 0, 1.0f);//DISABLECRAVEN
//        }
//
//        ImGuiIO& io = ImGui::GetIO();
//#ifdef _WIN32
